      ...
      <section className='bg-richblack-700'>
        <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
            <header className='mx-auto py-20 text-4xl font-semibold lg:w-[70%]'>
                ...
                <p className='mx-auto mt-3 text-center text-base font-medium text-richblack-300 lg:w-[95%]'>LearnHub is an online learning platform helping students learn web development, AI, programming, and modern technologies through practical projects and interactive learning.</p>
            </header>
        ...
        <div className='mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500'>
            ...
            <div className='flex flex-col items-center gap-10 lg:flex-row justify-between '>
                ...
                <div className='my-24 flex lg:w-[50%] flex-col gap-10'>
                    ...
                    <p className='text-base font-medium text-richblack-300 lg:w-[95%]'>LearnHub was created to help students gain practical technical skills and real-world knowledge through modern online learning experiences.</p>
